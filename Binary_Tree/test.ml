...
let _ = let s1 = Liststack.push 3 
	    ...
	    in 
			...
			print_string "\n";
			try ( 
				let s2 = Liststack.pop s1 in 
					Liststack.print s2 string_of_int;
					print_string "\n";
				let s3 = Liststack.pop s2 in 
					Liststack.print s3 string_of_int;
					print_string "\n";
				let s4 = Liststack.pop s3 in 
					Liststack.print s4 string_of_int;
					print_string "\n";
				let s5 = Liststack.pop s4 in 
					Liststack.print s5 string_of_int;
					print_string "\n"
			)
